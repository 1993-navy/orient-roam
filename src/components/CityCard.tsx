...
export function CityCard({ city }: { city: CityCardData }) {
  ...
  return (
    <Link
      href={`/city/${city.id}`}
      className="group flex flex-col rounded-2xl border border-black/5 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-white/10 dark:bg-neutral-900"
    >
