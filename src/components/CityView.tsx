      ...
      <div className="mt-4 flex flex-wrap gap-2">
        {PLACE_CATEGORIES.map((cat) => (
          <Link
            ...
            className="rounded-full border border-black/10 bg-white px-3 py-1.5 text-sm font-medium hover:bg-neutral-50 dark:border-white/15 dark:bg-neutral-900 dark:hover:bg-neutral-800"
          >
