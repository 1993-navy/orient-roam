...
// Place like pill — optimistic toggle + live count, reconciled with the server's
// authoritative { liked, likeCount }. Mirrors LikeButton (posts). Signed-out
// users are routed to sign in.
export function PlaceLikeButton({
  placeId,
  initialLiked = false,
  initialCount = 0,
}: {
